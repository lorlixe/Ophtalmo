...
router.get("/:id", authentification, authorization(1), HospitalCtrl.findHospital)
router.post('/', authentification, authorization(1), HospitalCtrl.setHospital);
router.put("/:id", authentification, authorization(1), HospitalCtrl.editHospital)
router.delete("/:id", authentification, authorization(1), HospitalCtrl.deleteHospital)
